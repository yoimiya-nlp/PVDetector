...
def generate_CSG_df_subgraph_cpp(root_node,index_to_code,states,code,new_tokens):
...
def generate_CSG_cf_subgraph_cpp(root_node):
    if_statement=['if_statement']
    for_statement=['for_statement']
    switch_statement=['switch_statement']
    while_statement=['while_statement']
...
def generate_CSG_vul_subgraph_cpp(root_node, index_to_code, states, code, new_tokens):
